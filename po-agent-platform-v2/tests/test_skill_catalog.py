...
def test_catalog_summary_is_machine_readable():
    summary=catalog_summary(); assert summary["total"]==54; assert summary["statuses"]["implemented"]==47; assert summary["statuses"]["planned"]==7; assert summary["by_domain"]["tasks"]==21; assert summary["by_domain"]["sprints"]==12; assert summary["by_domain"]["team"]==8; assert summary["by_domain"]["releases"]==7
