...
CAPABILITIES = (
    ...
    CapabilitySpecV4(
        "task.search_attachments",
        "Find REAL AS21 tasks that have attachments, optionally filtered by attachment type.",
        {"attachment_type": "optional enum: excel|word|pdf|msg|image|text|other"},
    ),
    CapabilitySpecV4(
        "task.search_release",
...
SKILLS = (
    ...
    SkillSpecV4(
        ...
        ("Call task.search_attachments without attachment_type for the full attachment-bearing task set.",),
        ("task.search_attachments",),
    ...
    SkillSpecV4(
        ...
        ("Call task.search_attachments with attachment_type=excel.",),
        ("task.search_attachments",),
        completion=(CompletionRequirement("task.search_attachments", data_keys=("count", "attachment_type")),),
    ),
    SkillSpecV4(
        "task.search_pdf",
        "Find tasks that contain PDF attachments.",
        ("Call task.search_attachments with attachment_type=pdf.",),
        ("task.search_attachments",),
        completion=(CompletionRequirement("task.search_attachments", data_keys=("count", "attachment_type")),),
    ),
    SkillSpecV4(
        ...
        ("Call task.search_attachments with attachment_type=msg.",),
        ("task.search_attachments",),
        completion=(CompletionRequirement("task.search_attachments", data_keys=("count", "attachment_type")),),
    ),
    SkillSpecV4(
