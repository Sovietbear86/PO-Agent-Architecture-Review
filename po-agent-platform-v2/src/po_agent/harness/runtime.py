...
class DeterministicRouter:
    ...
    def route(self,q):
        ...
        if any(x in l for x in ("дайджест","утренняя сводка","дневная сводка","daily brief","краткий бриф")): return "po_daily_brief",{}
