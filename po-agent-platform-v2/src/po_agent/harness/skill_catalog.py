...
SKILL_CATALOG: tuple[SkillCatalogEntry, ...] = (
    ...
    SkillCatalogEntry("team-assignee-recommendation", "team", "team.assignee_recommendation", "Recommend assignee using competencies and load.", "implemented", requires_llm=True),
