...
SKILL_CATALOG: tuple[SkillCatalogEntry, ...] = (
    ...
    SkillCatalogEntry("sprint-health", "sprints", "sprint.health", "Assess sprint health and readiness using grounded progress, flow, blocker and risk signals.", "implemented"),
    ...
    SkillCatalogEntry("sprint-carryover", "sprints", "sprint.carryover", "Measure carryover from committed scope.", "implemented"),
    SkillCatalogEntry("sprint-scope-change", "sprints", "sprint.scope_change", "Measure scope change after sprint start.", "implemented"),
    ...
    SkillCatalogEntry("team-competency-match", "team", "team.competency_match", "Match task requirements to declared competencies.", "implemented", requires_llm=True),
    SkillCatalogEntry("team-assignee-recommendation", "team", "team.assignee_recommendation", "Recommend who should be assigned to a task using declared competencies and current workload.", "implemented", requires_llm=True),
    ...
    SkillCatalogEntry("release-forecast", "releases", "release.forecast", "Provide deterministic forecast inputs and bounded forecast output.", "implemented"),
    ...
    SkillCatalogEntry("po-reminder-draft", "po", "po.reminder_draft", "Draft a contextual reminder/action message without sending it.", "implemented", requires_llm=True),
