...
A206_HISTORY_STATUS_SOURCE_DIAGNOSTIC = FIXABLE_RED
A206_OWNER_HISTORY_STATUS_FIX = VERIFIED_EXCEPT_SOURCE_STATUS_LABEL_PRESERVATION
A206_REGATE_1 = RED_AGENT_SIDE_STATUS_LABEL_LOSS_ONLY
A206_OWNER_STATUS_LABEL_FIX = GREEN_A206B
A206B_ROLLBACK_CHECKPOINT = checkpoint/v4-a206b-green@f7f846dee71b676fb0fc8d1d8f0d8aa23d521eaf
WAVE_S1_OWNER_IMPLEMENTATION = GREEN_A207
WAVE_S1_SKILLS = sprint.scope,sprint.velocity,sprint.throughput,sprint.wip,release.search
WAVE_S1_ROLLBACK_CHECKPOINT = checkpoint/v4-wave-s1-green@ce64264c868afd73743d5daafdeaee767e07adef
A208_MANUAL_TEST_HARDENING = IMPLEMENTED_PENDING_QA
A208_SCOPE = raw_source_status_filter,blocked_task_drilldown,current_or_period_sprint_resolution_for_S1_metrics
CURRENT_GATE = A208_PRE_S2_MANUAL_REGRESSION_GATE
NEXT_AFTER_A208_GREEN = OWNER_IMPLEMENT_WAVE_S2
